                        ...
                        <div class="box_price my-3 d-flex align-items-center">
                            ...
                            <div class="price_container" style="position: relative;">
                                @if(isset($productInfor['price_sale']) && $productInfor['price_sale'] > 0)
                                    <p class="price_sale" style="color: red; top">${{$productInfor['price_sale']}}</p>
                                    <p class="price_regular" style="position: absolute; top: 0; left: 0; text-decoration: line-through;">${{$productInfor['price_regular']}}</p>
                                @else
                                    <p class="price_regular">${{$productInfor['price_regular']}}</p>
                                @endif
                            </div>
