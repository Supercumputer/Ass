...
@section('content')
    ...
    <div class="box_content py-3">
        ...
        <div class="row">
                ...
                <div class=" col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-3">
                    <a href="/san_pham/index.php?san_pham_chi_tiet=" class="box_sp d-flex flex-column">
    ...
    <div class="box_content py-3">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-3">
                <a href="<?= $SITE_URL ?>/san_pham/index.php?san_pham_chi_tiet=" class="box_sp d-flex flex-column">
                    <div class="box_img_sp d-flex justify-content-center">
                        <img src="{{ asset('assets/client/img/slider_1.jpg') }}" alt="">
                    </div>
