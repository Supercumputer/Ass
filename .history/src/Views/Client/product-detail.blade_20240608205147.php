        ...
        <div class="box_content py-3">
            <div class="mgbg">
                <div class="row padi">
                    ...
                    <div class="col-lg-6">
                        <h1 class="name_product">San pham 1</h1>
                        ...
                        <div class="box_price my-3 d-flex align-items-center">
                            ...
                            <p class="price_product">100000000000 đ</p>
        ...
        <div class="box_content pb-3">
            <div class="mgbg p-3">
                ...
                <div class="box_infor_ct d-flex flex-column gap-3">
                    <p class="d-flex"><span class="mjh">Danh muc:</span><span class="okl"><?= $category_name ?></span>
                    </p>
                    <p class="d-flex"><span class="mjh">Ngày sản xuất:</span><span
                            class="okl"><?= $created_at ?></span></p>
