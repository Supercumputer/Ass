                ...
                <div class="row padi">
                    ...
                    <div class="col-lg-6">
                        ...
                        {{-- <div class="box_price my-3 d-flex align-items-center">
                            <p class="t_price">đ{{$productInfor['price_regular']}}</p>
                                 <p>-</p>
                               <p class="t_discount">đ{{$productInfor['price_sale']}}</p>
                        </div> --}}

                        <div class="box_price my-3 d-flex align-items-center">
                            
                               @if($productInfor['price_sale'])
                                   <p class="t_price">đ'.number_format($productInfor['price_regular'], 0, "", ".").</p> - <p class="t_discount mx-1">₫'.number_format($sale_price, 0, "", ".")</p>;
                                 @else
                                 <p class="t_discount">₫'.number_format($infor_varian['price'], 0, "", ".").</p>;
                                 @endif
