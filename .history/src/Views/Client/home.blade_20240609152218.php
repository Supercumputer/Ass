    ...
    <div class="box_content py-3">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-3">
                <div href="{{ url('products/' . $produc['id']) }}" class="box_sp d-flex flex-column">
                    <a href="{{ url('products/' . ['id']) }}"
                        class="box_img_sp d-flex justify-content-center">
                        <img src="{{ asset(['img_thumbnail']) }}" alt="">
                    </a>
                    <h1 class="title">{{ ['name'] }}</h1>
                    <span>{{ number_format(['price_regular'], 0, '', '.') }} VNĐ</span>
                    <a href="{{ url('cart/add') }}?quantity=1&productID={{ ['id'] }}"
