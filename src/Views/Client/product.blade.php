                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                            ...
                            <div class="accordion-body">
                                ...
                                <a href="index.php?keyword" style="color: black; display:block;width:100%;padding:10px;">
                                    <?= $category_name ?></a>
                                <a href="index.php?keyword" style="color: black; display:block;width:100%;padding:10px;">
                                    <?= $category_name ?></a>
                                <a href="index.php?keyword" style="color: black; display:block;width:100%;padding:10px;">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                            ...
                            <div class="accordion-body">
                                ...
                                <a href="index.php?keyword="
                                    style="color: black; display:block;width:100%;padding:10px;"><?= $color_name ?></a>
                                <?php endforeach ?>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                ...
                                <a href="index.php?keyword="
                                    style="color: black; display:block;width:100%;padding:10px;"><?= $size_name ?></a>
                                <?php endforeach ?>
